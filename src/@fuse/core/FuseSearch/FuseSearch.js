...
function reducer(state, action) {
    switch (action.type) {
        ...
        case 'setFileAndFolder': {
          return {
              ...state,
              fileAndFolder: action.value,
          };
      }
        case 'update-fileAndFolder-Suggestions': {
          const suggestions = getSuggestions(action.value, state.fileAndFolder);
...
function FuseSearch(props) {
    ...
    const fileAndFolder = navigation;
